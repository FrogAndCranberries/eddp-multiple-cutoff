...
program frank_new
  ...
  real(kind=gp) :: pmin=2.0_gp,pmax=15.0_gp
  real(kind=gp) :: rmax(5)
...
contains
  ...
  subroutine generate_features()
    ...
    real(kind=gp) :: length2(num_super),rmax2(5)
             ...
             if(dij2(nj,ni).lt.rmax2(2)) then
                ...
                if(num_body.ge.3) then
                   ...
                   do nk=nj+1,num_super
                      ...
                      if((dij2(nj,ni).lt.rmax2(3)).and.(dij2(nk,ni).lt.rmax2(3)).and.(dij2(nk,nj).lt.rmax2(3))) then
                         ...
                         if(num_body.ge.4) then
                            ...
                            do nl=nk+1,num_super
                               ...
                               if((dij2(nj,ni).lt.rmax2(4)).and.(dij2(nk,ni).lt.rmax2(4)).and.&
                               (dij2(nk,nj).lt.rmax2(4)).and.(dij2(nl,ni).lt.rmax2(4)).and.&
                               (dij2(nk,nl).lt.rmax2(4)).and.(dij2(nj,nl).lt.rmax2(4))) then 
                                  ...
                                  if(num_body.ge.5) then
                                     ...
                                     do nm=nl+1,num_super
                                        ...
                                        if((dij2(nj,ni).lt.rmax2(5)).and.(dij2(nk,ni).lt.rmax2(5)).and.&
                                        (dij2(nk,nj).lt.rmax2(5)).and.(dij2(nl,ni).lt.rmax2(5)).and.&
                                        (dij2(nk,nl).lt.rmax2(5)).and.(dij2(nj,nl).lt.rmax2(5)).and.&
                                        (dij2(nm,ni).lt.rmax2(5)).and.(dij2(nk,nm).lt.rmax2(5)).and.&
                                        (dij2(nj,nm).lt.rmax2(5)).and.(dij2(nl,nm).lt.rmax2(5))) then 
    ...
    write (stdout,'(1x,10(a,1x),a,5(1x,f7.3),a,1x,i0,a,4(1x,i0),a,*(1x,f0.3))') &
  ...
  function f(r, order)
    ...
    if(r.gt.rmax(order)) stop 'f(r): r>rmax'
...
99  write (stderr,*) buff_words(1:10,1)
  ...
  subroutine generate_supercluster()
    ...
    real(kind=gp) :: vnm(3),vm(3),rnm2,rmax2(5),h(3),diag
    ...
    nmax(1) = int((rmax(1)+diag)/h(1))
    nmax(2) = int((rmax(1)+diag)/h(2))
    nmax(3) = int((rmax(1)+diag)/h(3))

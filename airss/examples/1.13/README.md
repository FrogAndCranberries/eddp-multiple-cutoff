Here we search for an interface between the A and B binary Lennard-Jones atoms. Again, check the output of the random structure generation before optimisation.
